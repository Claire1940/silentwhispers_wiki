...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Silent Whispers Wiki",
    description: "Read the Terms of Service for Silent Whispers Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Silent Whispers Wiki",
      description: "Terms and conditions for using Silent Whispers Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Silent Whispers Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Silent Whispers Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Silent Whispers Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Silent Whispers Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the UE5 cinematic love adventure "Silent Whispers". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Character guides and story breakdowns</li>
              <li>Romance and relationship guides</li>
              <li>City of Fading Light exploration info</li>
              <li>Release date and pre-registration updates</li>
              <li>Trailer and gameplay analysis</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Silent Whispers Wiki is NOT affiliated with, endorsed by, or associated with
              Archosaur Games or the official developers of Silent Whispers. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Silent Whispers Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Archosaur Games and/or the developers of Silent Whispers. We use such
            ...
            <ul>
              ...
              <li><strong>Pre-Registration:</strong> Pre-registration rewards, release dates, and game updates may change without notice. We are not responsible for availability or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SILENT WHISPERS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Discord, Reddit, social media platforms,
            ...
            <p>
              ...
              you and Silent Whispers Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@silentwhispers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@silentwhispers.wiki</a>
            </p>
            <p>
