...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Silent Whispers Wiki',
    description: 'Copyright and intellectual property information for Silent Whispers Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Silent Whispers Wiki',
      description: 'Copyright and intellectual property information for Silent Whispers Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Silent Whispers Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Silent Whispers Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Silent Whispers Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Archosaur Games</strong> - Developer and publisher of Silent Whispers</li>
              <li><strong>Unreal Engine 5</strong> - Game engine by Epic Games</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Silent Whispers</strong> - Trademark of Archosaur Games</li>
              <li><strong>Unreal Engine 5</strong> - Trademark of Epic Games</li>
              <li><strong>Silent Whispers Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Silent Whispers Wiki.
            </p>
            ...
            <p>
              ...
              Silent Whispers Wiki<br />
              Email: <a href="mailto:dmca@silentwhispers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@silentwhispers.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Silent Whispers Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Silent Whispers Wiki (silentwhispers.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@silentwhispers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@silentwhispers.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@silentwhispers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@silentwhispers.wiki</a>
            </p>
            <p>
