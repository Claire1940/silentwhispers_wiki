...
export default function HomePageClient({
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      {
        "@type": "VideoObject",
        name: "Silent Whispers - World Premiere PV",
        description:
          "Official Silent Whispers World Premiere PV trailer for the UE5 cinematic love adventure set in the City of Fading Light.",
        uploadDate: "2026-03-12",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/JMXLe7YUDeE",
        url: "https://www.youtube.com/watch?v=JMXLe7YUDeE",
      },
    ],
  };
  ...
  // Tools Grid 卡片映射到模块 section id（顺序与 tools.cards 一致）
  const toolSectionIds = [
    ...
    "beginner-guide",
    "story-and-world",
    "trailers-and-tech-demo",
    "codes-and-redeem-status",
  ];
  ...
  return (
    <div className="home-shell min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              <button
                onClick={() => scrollToSection("pre-registration-rewards")}
              ...
              <a
                href="https://whispers.archosaur.com/en/index.html"
                target="_blank"
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="JMXLe7YUDeE"
              title="Silent Whispers - World Premiere PV"
            />
          </div>
        </div>
      </section>

      {/* Tools Grid - 8 Navigation Cards (max-w-5xl, 位于视频之后、最新动态之前) */}
      ...
      {/* Latest Updates Section（保留，内容为空时自动隐藏） */}
      ...
      <section id="release-date-and-platforms" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {t.modules.silentWhispersReleaseDateAndPlatforms.items.map(
              (item: any, index: number) => (
                ...
                >
                  ...
                  <p className="text-lg font-bold text-[hsl(var(--nav-theme-light))] mb-2">
                    {item.value}
                  </p>
      ...
      {/* Module 2: Pre-Registration Rewards (reward-cards) */}
      <section id="pre-registration-rewards" className="scroll-mt-24 px-4 py-14 md:py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.silentWhispersPreRegistrationRewards.items.map(
              (item: any, index: number) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground italic">{item.claim_context}</p>
                </div>
              ),
            )}
          </div>
      ...
      {/* Module 3: Characters (character-cards) */}
      <section id="characters" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {t.modules.silentWhispersCharacters.items.map((item: any, index: number) => (
              <div
                key={index}
                className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-12 w-12 rounded-full bg-[hsl(var(--nav-theme)/0.15)] border border-[hsl(var(--nav-theme)/0.3)] flex items-center justify-center">
                ...
                <p className="text-sm text-muted-foreground mb-3">{item.story_profile}</p>
                <p className="text-xs text-muted-foreground mb-1">
                  <span className="font-semibold not-italic">Voice:</span> {item.voice_info}
                </p>
                <p className="text-xs text-muted-foreground">
                  <span className="font-semibold not-italic">Known from:</span> {item.known_from}
                </p>
              </div>
            ))}
          </div>
      ...
      {/* Module 4: Gameplay and Features (feature-grid) */}
      <section id="gameplay-and-features" className="scroll-mt-24 px-4 py-14 md:py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {t.modules.silentWhispersGameplayAndFeatures.items.map(
              (item: any, index: number) => (
                <div
                  key={index}
                  className="p-5 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
      ...
      <section id="beginner-guide" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal space-y-3 md:space-y-4 mb-8 md:mb-10">
            {t.modules.silentWhispersBeginnerGuide.steps.map((step: any, index: number) => (
              <div
                key={index}
          ...
          <div className="scroll-reveal p-4 md:p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            ...
            <ul className="space-y-2">
              {t.modules.silentWhispersBeginnerGuide.quickTips.map((tip: string, index: number) => (
      ...
      {/* Module 6: Story and World (lore-cards) */}
      <section id="story-and-world" className="scroll-mt-24 px-4 py-14 md:py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.silentWhispersStoryAndWorld.items.map((item: any, index: number) => (
              <div
                key={index}
                className="p-5 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
              >
      ...
      {/* Module 7: Trailers and Tech Demo (video-gallery) */}
      <section id="trailers-and-tech-demo" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4">
            {t.modules.silentWhispersTrailersAndTechDemo.items.map((item: any, index: number) => (
              <div
                key={index}
                className="p-5 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
              >
                ...
                <div className="flex flex-wrap gap-1.5 mb-3">
                  {item.tags.map((tag: string, i: number) => (
                    <span
                      key={i}
                      className="text-[10px] px-2 py-0.5 rounded-full bg-[hsl(var(--nav-theme)/0.08)] border border-[hsl(var(--nav-theme)/0.2)]"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-sm font-semibold text-[hsl(var(--nav-theme-light))] hover:underline mb-3"
                >
                  Watch on YouTube <ExternalLink className="w-3.5 h-3.5" />
                </a>
                <ul className="space-y-1">
                  {item.confirms.map((c: string, i: number) => (
                    <li key={i} className="flex items-start gap-2">
                      <Check className="w-3.5 h-3.5 text-[hsl(var(--nav-theme-light))] mt-1 flex-shrink-0" />
      ...
      {/* Module 8: Codes and Redeem Status (code-status-cards) */}
      <section id="codes-and-redeem-status" className="scroll-mt-24 px-4 py-14 md:py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4">
            {t.modules.silentWhispersCodesAndRedeemStatus.items.map((item: any, index: number) => (
              <div
                key={index}
                className="p-5 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
              >
                ...
                <div className="space-y-1 mb-3 text-sm">
                  ...
                  <p className="text-muted-foreground">
                    <span className="font-semibold not-italic">Reward:</span> {item.reward}
                  </p>
                  <p className="text-muted-foreground">
                    <span className="font-semibold not-italic">Expires:</span> {item.expires}
                  </p>
                </div>
                <ul className="space-y-1">
                  {item.details.map((d: string, i: number) => (
